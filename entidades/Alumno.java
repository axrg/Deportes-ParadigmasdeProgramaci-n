...
public class Alumno {
    ...
    public Alumno(int idalumno, String nombres, String apellidos, String curp, String sexo, Date fechanac, String nompadre,String nommadre, String nomapoderado, String telefono, String celular, String direccion, String distrito, String estado) {
        this.idalumno = idalumno;
        this.nombres = nombres;
        this.apellidos = apellidos;
        this.curp = curp;
